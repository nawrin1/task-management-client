...
const Banner = () => {
    ...
    return (
        <div className="ban ">
            ...
            <Link to='/login'><button className='btn btn-sm bg-green-600 relative top-[35%] ml-[210px] lg:top-[50%] md:top-[40%]  lg:ml-[760px] md:ml-[480px] text-white ' data-aos="zoom-out" data-aos-duration="4000">Let's Explore</button> </Link>
